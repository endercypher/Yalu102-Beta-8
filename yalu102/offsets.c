...
void init_offsets() {
    ...
    */
    ...
    if (strcmp(u.version, “Darwin Kernel Version 16.3.0 Tue Nov 1 22:23:11 PDT 2016/RELEASE_ARM64_T7001") == 0) {
        allproc_offset = 0x5b8528;
        rootvnode_offset = 0x5be0b8;

}     

    else if (strcmp(u.version, "Darwin Kernel Version 16.3.0: Tue Nov 29 21:40:08 PST 2016; root:xnu-3789.32.1~4/RELEASE_ARM64_S8000”) == 0) {
        allproc_offset = 00x5a8238;
        rootvnode_offset = 0x5ae0e;
    }
}     
